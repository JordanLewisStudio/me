...
def is_it_5(some_number) -> bool:
    ...
    if some_number == "5" or some_number == 5:
        return True
    else:
        return False
...
def set_it_on_fire(input_string="very naughty boy") -> str:
    ...
    """
    fire_list = list(input_string)
    fire_list = "🔥".join(fire_list)
    return "🔥" + fire_list.upper() + "🔥"
...
def random_filler_text(number_of_words=200) -> str:
    ...
    words = []
    for l in range(number_of_words):
...
def fast_filler(number_of_words=200) -> str:
    ...
    for l in range(number_of_words):
        ...
        try:
            ...
            words.append(my_dict[str(length)][index])
